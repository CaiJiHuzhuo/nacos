...
public class NamingProxy implements Closeable {
    ...
    //NamingProxy的构造器执行了initRefreshSrvIfNeed方法，该方法在endpoint不为空的时候，会注册一个定时任务，
    // 每隔vipSrvRefInterMillis时间执行一次refreshSrvIfNeed方法，同时立马调用了refreshSrvIfNeed方法
    ...
    //如果serverlist不是用户提供的，且距离lastSrvRefTime大于等于vipSrvRefInterMillis时
    //会通过getServerListFromEndpoint()方法获取serverList更新serversFromEndpoint及lastSrvRefTime
